...
UI_PAGES = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"type": "text", "text": "SPDIF+", "command": {"cmd_id": "SPDIF+"}, "location": {"x": 0, "y": 2}, "size": {"width": 1, "height": 1}},
...
BUTTON_MAPPING = [
    ...
    {"button": Buttons.CHANNEL_UP, "short_press": {"cmd_id": "Dialog Up"}},
    {"button": Buttons.CHANNEL_DOWN, "short_press": {"cmd_id": "Dialog Down"}},
    {"button": Buttons.MUTE, "short_press": {"cmd_id": "Mute Toggle"}},
]


class HTP1Remote(RemoteEntity):
